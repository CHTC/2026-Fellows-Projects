...
1. Have fellows fork repository.
...
1. Develop and store project code in specific fellow directory
   if stand alone.
2. Store any testing code in specific fellow directory. Preferably
   execute a github action to run tests.
3. Store any project specific documenation in specific fellow
